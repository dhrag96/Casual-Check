...
public class Khome0 extends Activity implements View.OnClickListener {
	...
	public void onClick(View v) {
		...
		{
			Intent mIntent=new Intent(Khome0.this,home12.class);
			startActivity(mIntent);

		}
		else
		{
			Intent mIntent=new Intent(Khome0.this,efficiency.class);
			String eff1="0%";
